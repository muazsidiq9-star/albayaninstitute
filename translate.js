...
"Full name": "الاسم الكامل",
"Email address": "البريد الإلكتروني",
"Country or location": "الدولة أو الموقع",
"Payment details submitted by students": "تفاصيل الدفع المقدمة من الطلاب",
"Uploaded payment receipts": "إيصالات الدفع المرفوعة",
"Program selection and learning preferences": "اختيار البرنامج وتفضيلات التعلم",
"How We Use Your Information": "كيف نستخدم معلوماتك",
"Your information is used only for educational and administrative purposes.": "تُستخدم معلوماتك فقط لأغراض تعليمية وإدارية.",
"To verify and confirm enrollment": "للتحقق من التسجيل وتأكيده",
"To process payment confirmations": "لمعالجة تأكيدات الدفع",
"To communicate important class updates": "لإرسال تحديثات مهمة حول الحصص",
...
"However, while we strive to protect your information, no online system can guarantee absolute security.": "ومع ذلك، وعلى الرغم من سعينا لحماية معلوماتك، لا يمكن لأي نظام إلكتروني ضمان أمان مطلق.",
"Third-Party Services": "خدمات الطرف الثالث",
"We may use trusted external services to support our platform and payment operations.": "قد نستخدم خدمات خارجية موثوقة لدعم منصتنا وعمليات الدفع.",
"Selar (payment processing)": "Selar (معالجة الدفع)",
"Supabase (database/storage)": "Supabase (قاعدة البيانات والتخزين)",
"EmailJS (email communication)": "EmailJS (التواصل عبر البريد الإلكتروني)",
"Student Responsibility": "مسؤولية الطالب",
"Students are responsible for ensuring that the information submitted during registration and payment confirmation is accurate.": "يتحمل الطلاب مسؤولية التأكد من صحة المعلومات المقدمة أثناء التسجيل وتأكيد الدفع.",
...
"You were charged more than once for the same registration due to a technical error": "تم تحصيل المبلغ منك أكثر من مرة لنفس التسجيل بسبب خطأ تقني",
"You paid for a plan or class that we are unable to provide": "دفعت مقابل خطة أو حصة لم نتمكن من توفيرها",
"When Refunds Are Not Available": "متى لا يتوفر الاسترداد",
"To keep this fair for all students and instructors, refunds are not issued if:": "للحفاظ على العدالة لجميع الطلاب والمعلمين، لا يتم إصدار استرداد إذا:",
"Classes have already started and you have attended one or more sessions": "بدأت الحصص بالفعل وحضرت حصة واحدة أو أكثر",
"The request is made after 7 days from the payment date": "تم تقديم الطلب بعد 7 أيام من تاريخ الدفع",
"You simply change your mind after gaining access to class materials or recordings": "قمت ببساطة بتغيير رأيك بعد الحصول على إمكانية الوصول إلى مواد الحصص أو التسجيلات",
"The delay or missed classes are due to circumstances outside our control": "كان التأخير أو تفويت الحصص بسبب ظروف خارجة عن إرادتنا",
"How to Request a Refund": "كيفية طلب الاسترداد",
"Send us a message with your full name, payment reference or transaction ID, and the reason for your request. We'll respond and let you know the outcome within 3–5 business days.": "أرسل لنا رسالة تتضمن اسمك الكامل، ومرجع الدفع أو رقم المعاملة، وسبب طلبك. سنرد عليك ونعلمك بالنتيجة خلال 3-5 أيام عمل.",
"Refund Method & Timing": "طريقة الاسترداد وتوقيته",
"Approved refunds are returned to the original payment method used at checkout via Selar, or directly to the account you paid from for manual bank transfers.": "تُعاد الاستردادات المعتمدة إلى وسيلة الدفع الأصلية المستخدمة عند الدفع عبر Selar، أو مباشرة إلى الحساب الذي دفعت منه في حالة التحويل البنكي اليدوي.",
"Please allow 5–10 business days for the refund to reflect, depending on your bank or card issuer's processing time. This is outside our control once the refund has been initiated on our end.": "يرجى الانتظار من 5 إلى 10 أيام عمل حتى يظهر الاسترداد، وذلك حسب مدة معالجة البنك أو مُصدر البطاقة. هذا الأمر خارج عن إرادتنا بمجرد بدء عملية الاسترداد من جانبنا.",
"Plan Changes Instead of a Refund": "تغيير الخطة بدلاً من الاسترداد",
"If you'd prefer to switch plans rather than cancel entirely, let us know — we're happy to adjust your registration and apply any price difference instead of processing a full refund.": "إذا كنت تفضل تغيير خطتك بدلاً من الإلغاء التام، أخبرنا — يسعدنا تعديل تسجيلك وتطبيق أي فرق في السعر بدلاً من إجراء استرداد كامل.",
"To request a refund or ask a question about this policy, please contact us:": "لطلب استرداد أو طرح سؤال حول هذه السياسة، يرجى التواصل معنا:",
...
"Access to classes is granted only once payment has been confirmed": "يُمنح الوصول إلى الحصص فقط بعد تأكيد الدفع",
"You are responsible for any bank or card charges applied by your provider": "أنت مسؤول عن أي رسوم بنكية أو رسوم بطاقة يفرضها مزود الخدمة الخاص بك",
"Class Conduct": "سلوك الحصة",
"Students are expected to attend classes punctually, participate respectfully, and treat instructors and fellow students with courtesy. We reserve the right to suspend or remove any student whose conduct disrupts learning for others.": "يُتوقع من الطلاب حضور الحصص في مواعيدها، والمشاركة باحترام، ومعاملة المعلمين وزملائهم الطلاب بلطف. نحتفظ بالحق في إيقاف أو إبعاد أي طالب يُخل سلوكه بتعلم الآخرين.",
...
/* ── Rewards tab ── */
"Rewards": "المكافآت",
"Student Rewards": "مكافآت الطلاب",
"Unclaimed & Pending": "غير مطالب بها ومعلقة",
...
"No rewards match this filter": "لا توجد مكافآت مطابقة لهذا الفلتر",
"Failed to load rewards.": "فشل تحميل المكافآت.",
"Grant": "منح",
"discount to": "خصمًا لـ",
"Reward granted ✅": "تم منح المكافأة ✅",
"Failed to grant reward": "فشل منح المكافأة",
"in unclaimed/pending discounts across": "من الخصومات غير المطالب بها/المعلقة عبر",
"reward(s)": "مكافأة/مكافآت",
...
"Carryover Access": "صلاحية الترحيل",
"Carryover / Individual Course Access": "الترحيل / الوصول الفردي للمقرر",
"Grant one specific student access to a course they wouldn't normally see, without opening it to their whole level or batch.": "امنح طالبًا معينًا صلاحية الوصول إلى مقرر لا يظهر له عادة، دون فتحه لكامل مستواه أو دفعته.",
"Student (Matric Number)": "الطالب (الرقم الجامعي)",
"e.g. AB/2024/001": "مثال: AB/2024/001",
"Reason": "السبب",
"e.g. Carryover": "مثال: ترحيل",
"Grant Access": "منح الصلاحية",
"Granted On": "تاريخ المنح",
...
"This student already has access to that course": "هذا الطالب لديه بالفعل صلاحية الوصول إلى هذا المقرر",
"Access granted ✅": "تم منح الصلاحية ✅",
"Failed to grant access": "فشل منح الصلاحية",
"Revoke this student's access to this course?": "هل تريد إلغاء وصول هذا الطالب إلى هذا المقرر؟",
...
"Course Registration Control": "التحكم في تسجيل المقررات",
"When locked, students cannot register or unregister for any course until you unlock it here.": "عند القفل، لا يمكن للطلاب التسجيل أو إلغاء التسجيل في أي مقرر حتى تقوم بإلغاء القفل من هنا.",
"Registration is LOCKED — students cannot register or unregister": "التسجيل مُقفل — لا يمكن للطلاب التسجيل أو إلغاء التسجيل",
"Registration is OPEN": "التسجيل مفتوح",
"Lock Registration": "قفل التسجيل",
"Unlock Registration": "إلغاء قفل التسجيل",
"Lock course registration? Students will be unable to register or unregister until you unlock it.": "هل تريد قفل تسجيل المقررات؟ لن يتمكن الطلاب من التسجيل أو إلغاء التسجيل حتى تقوم بإلغاء القفل.",
"Unlock course registration? Students will be able to register again.": "هل تريد إلغاء قفل تسجيل المقررات؟ سيتمكن الطلاب من التسجيل مرة أخرى.",
"Registration locked 🔒": "تم قفل التسجيل 🔒",
"Registration unlocked 🔓": "تم إلغاء قفل التسجيل 🔓",
"Error updating registration lock: ": "خطأ في تحديث حالة القفل: ",
"Registration is currently closed": "التسجيل مغلق حالياً",
"Course registration has been temporarily locked by the administration. Please check back later.": "تم قفل تسجيل المقررات مؤقتاً من قبل الإدارة. يرجى المحاولة لاحقاً.",
"Message students see while locked (optional)": "الرسالة التي يراها الطلاب أثناء القفل (اختياري)",
"Course registration has now been permanently locked. Please contact the admin.": "تم قفل تسجيل المقررات بشكل دائم الآن. يرجى التواصل مع المسؤول.",
"Residence:": "الإقامة:",
"Residence": "الإقامة",
// ===== DYNAMIC TEMPLATES ===== 
